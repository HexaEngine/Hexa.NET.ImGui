...
namespace Hexa.NET.ImGui
{
	...
	public enum ImGuiItemFlagsPrivate : int
	{
		...
		/// <summary>
		/// false      [EXPERIMENTAL: Not very well specced] Clicking doesn't take focus. Automatically sets ImGuiButtonFlags_NoFocus + ImGuiButtonFlags_NoNavFocus in ButtonBehavior().<br/>
		/// </summary>
