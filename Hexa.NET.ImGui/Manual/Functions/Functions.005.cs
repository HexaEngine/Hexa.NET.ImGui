...
namespace Hexa.NET.ImGui
{
	public unsafe partial class ImGui
	{
		...
		internal static byte TempInputTextNative(ImRect bb, int id, byte* label, byte* buf, int bufSize, ImGuiInputTextFlags flags)
		{
			...
			return ((delegate* unmanaged[Cdecl]<ImRect, int, byte*, byte*, int, ImGuiInputTextFlags, byte>)funcTable[1442])(bb, id, label, buf, bufSize, flags);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<ImRect, int, nint, nint, int, ImGuiInputTextFlags, byte>)funcTable[1442])(bb, id, (nint)label, (nint)buf, bufSize, flags);
			#endif
		}
		...
		/// To be documented.
		/// </summary>
		public static bool TempInputText(ImRect bb, int id, ref byte label, ref string buf, int bufSize, ImGuiInputTextFlags flags)
		{
			fixed (byte* plabel = &label)
			{
				byte* pStr0 = null;
		...
		/// To be documented.
		/// </summary>
		public static bool TempInputText(ImRect bb, int id, ReadOnlySpan<byte> label, ref string buf, int bufSize, ImGuiInputTextFlags flags)
		{
			fixed (byte* plabel = label)
			{
				byte* pStr0 = null;
		...
		/// To be documented.
		/// </summary>
		public static bool TempInputText(ImRect bb, int id, string label, ref byte buf, int bufSize, ImGuiInputTextFlags flags)
		{
			byte* pStr0 = null;
			int pStrSize0 = 0;
			if (label != null)
