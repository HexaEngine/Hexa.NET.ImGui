...
namespace Hexa.NET.ImGui
{
	public unsafe partial class ImGui
	{
		...
		internal static int ImFormatStringNative(byte* buf, ulong bufSize, byte* fmt)
		{
			...
			return ((delegate* unmanaged[Cdecl]<byte*, ulong, byte*, int>)funcTable[1434])(buf, bufSize, fmt);
			#else
			return (int)((delegate* unmanaged[Cdecl]<nint, ulong, nint, int>)funcTable[1434])((nint)buf, bufSize, (nint)fmt);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<byte*, ulong, byte*, nuint, int>)funcTable[1435])(buf, bufSize, fmt, args);
			#else
			return (int)((delegate* unmanaged[Cdecl]<nint, ulong, nint, nuint, int>)funcTable[1435])((nint)buf, bufSize, (nint)fmt, args);
			#endif
		}
