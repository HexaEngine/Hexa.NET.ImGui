...
namespace Hexa.NET.ImGui
{
	public unsafe partial class ImGui
	{
		...
		internal static int ImFormatStringNative(byte* buf, nuint bufSize, byte* fmt)
		{
			...
			return ((delegate* unmanaged[Cdecl]<byte*, nuint, byte*, int>)funcTable[1525])(buf, bufSize, fmt);
			#else
			return (int)((delegate* unmanaged[Cdecl]<nint, nuint, nint, int>)funcTable[1525])((nint)buf, bufSize, (nint)fmt);
			#endif
		}
