...
namespace Hexa.NET.ImGui
{
	public unsafe partial class ImGui
	{
		...
		internal static int ImFormatStringNative(byte* buf, nuint bufSize, byte* fmt)
		{
			...
			return ((delegate* unmanaged[Cdecl]<byte*, nuint, byte*, int>)funcTable[1434])(buf, bufSize, fmt);
			#else
			return (int)((delegate* unmanaged[Cdecl]<nint, nuint, nint, int>)funcTable[1434])((nint)buf, bufSize, (nint)fmt);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<byte*, nuint, byte*, nuint, int>)funcTable[1435])(buf, bufSize, fmt, args);
			#else
			return (int)((delegate* unmanaged[Cdecl]<nint, nuint, nint, nuint, int>)funcTable[1435])((nint)buf, bufSize, (nint)fmt, args);
			#endif
		}
