...
namespace Hexa.NET.ImGui
{
	public unsafe partial class ImGui
	{
		...
		internal static int ImFormatStringNative(byte* buf, nuint bufSize, byte* fmt)
		{
			...
			#else
			return (int)((delegate* unmanaged[Cdecl]<nint, nuint, nint, int>)vt[1423])((nint)buf, bufSize, (nint)fmt);
			#endif
		}
		...
		internal static int ImFormatStringVNative(byte* buf, nuint bufSize, byte* fmt, nuint args)
		{
			...
			#else
			return (int)((delegate* unmanaged[Cdecl]<nint, nuint, nint, nuint, int>)vt[1424])((nint)buf, bufSize, (nint)fmt, args);
			#endif
		}
		...
		internal static byte* ImParseFormatTrimDecorationsNative(byte* format, byte* buf, nuint bufSize)
		{
			...
			#else
			return (byte*)((delegate* unmanaged[Cdecl]<nint, nint, nuint, nint>)vt[1425])((nint)format, (nint)buf, bufSize);
			#endif
		}
		...
		internal static byte TempInputTextNative(ImRect bb, int id, byte* label, byte* buf, int bufSize, ImGuiInputTextFlags flags)
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<ImRect, int, byte*, byte*, int, ImGuiInputTextFlags, byte>)vt[1431])(bb, id, label, buf, bufSize, flags);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<ImRect, int, nint, nint, int, ImGuiInputTextFlags, byte>)vt[1431])(bb, id, (nint)label, (nint)buf, bufSize, flags);
			#endif
		}
		...
		public static bool TempInputText(ImRect bb, int id, ReadOnlySpan<byte> label, byte* buf, int bufSize, ImGuiInputTextFlags flags)
		{
			fixed (byte* plabel = label)
			{
				byte ret = TempInputTextNative(bb, id, (byte*)plabel, buf, bufSize, flags);
		...
		public static bool TempInputText(ImRect bb, int id, ReadOnlySpan<byte> label, ref byte buf, int bufSize, ImGuiInputTextFlags flags)
		{
			fixed (byte* plabel = label)
			{
				fixed (byte* pbuf = &buf)
