...
typedef struct ImNodesEditorContext ImNodesEditorContext;typedef int ImNodesCol;
...
struct ImNodesStyle
{
    float GridSpacing;    float NodeCornerRounding;
    ImVec2 NodePadding;
    float NodeBorderThickness;    float LinkThickness;
...
}ImNodesMiniMapLocation_;struct ImGuiContext;
struct ImVec2;struct ImNodesContext;
struct ImNodesEditorContext;
typedef void (*ImNodesMiniMapNodeHoveringCallback)(int, void*);typedef void* ImNodesMiniMapNodeHoveringCallbackUserData;
#else
