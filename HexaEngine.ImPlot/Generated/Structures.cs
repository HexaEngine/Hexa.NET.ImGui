...
namespace HexaEngine.ImPlotNET
{
	...
	public partial struct ImPlotAxis
	{
		...
		public unsafe delegate* unmanaged[Cdecl]<double, byte*, int, void*, int> Formatter;
		...
		public unsafe delegate* unmanaged[Cdecl]<ImPlotTicker*, ImPlotRange, float, bool, ImPlotFormatter, void*, void> Locator;
		...
		public unsafe delegate* unmanaged[Cdecl]<double, void*, double> TransformForward;
		public unsafe delegate* unmanaged[Cdecl]<double, void*, double> TransformInverse;
	...
	public unsafe struct ImPlotAxisPtr : IEquatable<ImPlotAxisPtr>
	{
		...
		public delegate* unmanaged[Cdecl]<double, byte*, int, void*, int> Formatter { get => Handle->Formatter; set => Handle->Formatter = value; }
		...
		public delegate* unmanaged[Cdecl]<ImPlotTicker*, ImPlotRange, float, bool, ImPlotFormatter, void*, void> Locator { get => Handle->Locator; set => Handle->Locator = value; }
		...
		public delegate* unmanaged[Cdecl]<double, void*, double> TransformForward { get => Handle->TransformForward; set => Handle->TransformForward = value; }
		public delegate* unmanaged[Cdecl]<double, void*, double> TransformInverse { get => Handle->TransformInverse; set => Handle->TransformInverse = value; }
	...
	public partial struct FormatterTimeData
	{
		...
		public unsafe delegate* unmanaged[Cdecl]<double, byte*, int, void*, int> UserFormatter;
