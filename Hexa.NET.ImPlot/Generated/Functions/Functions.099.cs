...
namespace Hexa.NET.ImPlot
{
	public unsafe partial class ImPlot
	{
		...
		internal static double PlotHistogramNative(byte* labelId, short* values, int count, int bins, double barScale, ImPlotRange range, ImPlotHistogramFlags flags)
		{
			...
			return ((delegate* unmanaged[Cdecl]<byte*, short*, int, int, double, ImPlotRange, ImPlotHistogramFlags, double>)vt[263])(labelId, values, count, bins, barScale, range, flags);
			#else
			return (double)((delegate* unmanaged[Cdecl]<nint, nint, int, int, double, ImPlotRange, ImPlotHistogramFlags, double>)vt[263])((nint)labelId, (nint)values, count, bins, barScale, range, flags);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<byte*, ushort*, int, int, double, ImPlotRange, ImPlotHistogramFlags, double>)vt[264])(labelId, values, count, bins, barScale, range, flags);
			#else
			return (double)((delegate* unmanaged[Cdecl]<nint, nint, int, int, double, ImPlotRange, ImPlotHistogramFlags, double>)vt[264])((nint)labelId, (nint)values, count, bins, barScale, range, flags);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<byte*, int*, int, int, double, ImPlotRange, ImPlotHistogramFlags, double>)vt[265])(labelId, values, count, bins, barScale, range, flags);
			#else
			return (double)((delegate* unmanaged[Cdecl]<nint, nint, int, int, double, ImPlotRange, ImPlotHistogramFlags, double>)vt[265])((nint)labelId, (nint)values, count, bins, barScale, range, flags);
			#endif
		}
