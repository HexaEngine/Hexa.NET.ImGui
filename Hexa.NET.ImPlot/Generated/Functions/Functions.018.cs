...
namespace Hexa.NET.ImPlot
{
	public unsafe partial class ImPlot
	{
		...
		internal static void PlotStairsNative(byte* labelId, double* xs, double* ys, int count, ImPlotStairsFlags flags, int offset, int stride)
		{
			...
			((delegate* unmanaged[Cdecl]<byte*, double*, double*, int, ImPlotStairsFlags, int, int, void>)vt[107])(labelId, xs, ys, count, flags, offset, stride);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, nint, int, ImPlotStairsFlags, int, int, void>)vt[107])((nint)labelId, (nint)xs, (nint)ys, count, flags, offset, stride);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<byte*, sbyte*, sbyte*, int, ImPlotStairsFlags, int, int, void>)vt[108])(labelId, xs, ys, count, flags, offset, stride);
			#else
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<byte*, byte*, byte*, int, ImPlotStairsFlags, int, int, void>)vt[109])(labelId, xs, ys, count, flags, offset, stride);
			#else
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<byte*, short*, short*, int, ImPlotStairsFlags, int, int, void>)vt[110])(labelId, xs, ys, count, flags, offset, stride);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, nint, int, ImPlotStairsFlags, int, int, void>)vt[110])((nint)labelId, (nint)xs, (nint)ys, count, flags, offset, stride);
			#endif
		}
