...
namespace Hexa.NET.ImPlot
{
	public unsafe partial class ImPlot
	{
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<byte*, ImTextureID, ImPlotPoint, ImPlotPoint, Vector2, Vector2, Vector4, ImPlotImageFlags, void>)funcTable[290])(labelId, userTextureId, boundsMin, boundsMax, uv0, uv1, tintCol, flags);
			#else
			((delegate* unmanaged[Cdecl]<nint, ImTextureID, ImPlotPoint, ImPlotPoint, Vector2, Vector2, Vector4, ImPlotImageFlags, void>)funcTable[290])((nint)labelId, userTextureId, boundsMin, boundsMax, uv0, uv1, tintCol, flags);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<int, double*, Vector4, float, ImPlotDragToolFlags, bool*, bool*, bool*, byte>)funcTable[294])(id, x, col, thickness, flags, outClicked, outHovered, held);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<int, nint, Vector4, float, ImPlotDragToolFlags, nint, nint, nint, byte>)funcTable[294])(id, (nint)x, col, thickness, flags, (nint)outClicked, (nint)outHovered, (nint)held);
			#endif
		}
