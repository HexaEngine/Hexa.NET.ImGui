...
namespace Hexa.NET.ImPlot
{
	public unsafe partial class ImPlot
	{
		...
		internal static ImPlotItem* GetItemNative(byte* labelId)
		{
			...
			return ((delegate* unmanaged[Cdecl]<byte*, ImPlotItem*>)funcTable[646])(labelId);
			#else
			return (ImPlotItem*)((delegate* unmanaged[Cdecl]<nint, nint>)funcTable[646])((nint)labelId);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<ImPlotItem*>)funcTable[647])();
			#else
			return (ImPlotItem*)((delegate* unmanaged[Cdecl]<nint>)funcTable[647])();
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<ImPlotAxis*, int, byte>)funcTable[649])(axes, count);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<nint, int, byte>)funcTable[649])((nint)axes, count);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<ImPlotAxis*, int, byte>)funcTable[650])(axes, count);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<nint, int, byte>)funcTable[650])((nint)axes, count);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<ImPlotAxis*, int, byte>)funcTable[651])(axes, count);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<nint, int, byte>)funcTable[651])((nint)axes, count);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<ImPlotAxis*, int, byte>)funcTable[652])(axes, count);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<nint, int, byte>)funcTable[652])((nint)axes, count);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<byte>)funcTable[653])();
			#else
			return (byte)((delegate* unmanaged[Cdecl]<byte>)funcTable[653])();
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<double, void>)funcTable[654])(x);
			#else
			((delegate* unmanaged[Cdecl]<double, void>)funcTable[654])(x);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<double, void>)funcTable[655])(y);
			#else
			((delegate* unmanaged[Cdecl]<double, void>)funcTable[655])(y);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<ImPlotPoint, void>)funcTable[656])(p);
			#else
			((delegate* unmanaged[Cdecl]<ImPlotPoint, void>)funcTable[656])(p);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<ImPlotRange, ImPlotRange, byte>)funcTable[657])(r1, r2);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<ImPlotRange, ImPlotRange, byte>)funcTable[657])(r1, r2);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<ImPlotAxis*, ImPlotAxis*, byte, void>)funcTable[658])(axis, equalAxis, timeAllowed);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, byte, void>)funcTable[658])((nint)axis, (nint)equalAxis, timeAllowed);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<Vector2*, ImRect, Vector2, ImPlotLocation, Vector2, void>)funcTable[659])(pOut, outerRect, innerSize, location, pad);
			#else
			((delegate* unmanaged[Cdecl]<nint, ImRect, Vector2, ImPlotLocation, Vector2, void>)funcTable[659])((nint)pOut, outerRect, innerSize, location, pad);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<Vector2*, ImPlotItemGroup*, Vector2, Vector2, byte, void>)funcTable[660])(pOut, items, pad, spacing, vertical);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, Vector2, Vector2, byte, void>)funcTable[660])((nint)pOut, (nint)items, pad, spacing, vertical);
			#endif
		}
		...
		{
			Vector2 ret;
			CalcLegendSizeNative(&ret, (ImPlotItemGroup*)items, pad, spacing, vertical ? (byte)1 : (byte)0);
			return ret;
		}
		...
		{
			CalcLegendSizeNative(pOut, (ImPlotItemGroup*)items, pad, spacing, vertical ? (byte)1 : (byte)0);
		}
		...
		public static void CalcLegendSize(ref Vector2 pOut, ImPlotItemGroupPtr items, Vector2 pad, Vector2 spacing, bool vertical)
		{
			fixed (Vector2* ppOut = &pOut)
			{
				CalcLegendSizeNative((Vector2*)ppOut, (ImPlotItemGroup*)items, pad, spacing, vertical ? (byte)1 : (byte)0);
			}
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<ImRect*, ImRect, Vector2, byte>)funcTable[661])(legendRect, outerRect, pad);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<nint, ImRect, Vector2, byte>)funcTable[661])((nint)legendRect, outerRect, pad);
			#endif
		}
		...
		{
			byte ret = ClampLegendRectNative((ImRect*)legendRect, outerRect, pad);
			return ret != 0;
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<ImPlotItemGroup*, ImRect, byte, Vector2, Vector2, byte, ImDrawList*, byte>)funcTable[662])(items, legendBb, interactable, pad, spacing, vertical, drawList);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<nint, ImRect, byte, Vector2, Vector2, byte, nint, byte>)funcTable[662])((nint)items, legendBb, interactable, pad, spacing, vertical, (nint)drawList);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<byte*, byte, Vector2, byte, void>)funcTable[663])(titleId, vertical, size, interactable);
			#else
			((delegate* unmanaged[Cdecl]<nint, byte, Vector2, byte, void>)funcTable[663])((nint)titleId, vertical, size, interactable);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<ImPlotLegend*, byte, byte>)funcTable[664])(legend, visible);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<nint, byte, byte>)funcTable[664])((nint)legend, visible);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<ImPlotAxis, double, byte*, int, byte, void>)funcTable[665])(axis, value, buff, size, round);
			#else
			((delegate* unmanaged[Cdecl]<ImPlotAxis, double, nint, int, byte, void>)funcTable[665])(axis, value, (nint)buff, size, round);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<ImPlotNextItemData*>)funcTable[666])();
			#else
			return (ImPlotNextItemData*)((delegate* unmanaged[Cdecl]<nint>)funcTable[666])();
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<Vector4, byte>)funcTable[667])(col);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<Vector4, byte>)funcTable[667])(col);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<ImPlotCol, byte>)funcTable[668])(idx);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<ImPlotCol, byte>)funcTable[668])(idx);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<Vector4*, ImPlotCol, void>)funcTable[669])(pOut, idx);
			#else
			((delegate* unmanaged[Cdecl]<nint, ImPlotCol, void>)funcTable[669])((nint)pOut, idx);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<Vector4*, ImPlotCol, void>)funcTable[670])(pOut, idx);
			#else
			((delegate* unmanaged[Cdecl]<nint, ImPlotCol, void>)funcTable[670])((nint)pOut, idx);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<ImPlotCol, uint>)funcTable[671])(idx);
			#else
			return (uint)((delegate* unmanaged[Cdecl]<ImPlotCol, uint>)funcTable[671])(idx);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<ImDrawList*, Vector2, uint, byte*, byte*, void>)funcTable[672])(drawList, pos, col, textBegin, textEnd);
			#else
			((delegate* unmanaged[Cdecl]<nint, Vector2, uint, nint, nint, void>)funcTable[672])((nint)drawList, pos, col, (nint)textBegin, (nint)textEnd);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<ImDrawList*, Vector2, uint, byte*, byte*, void>)funcTable[673])(drawList, topCenter, col, textBegin, textEnd);
			#else
			((delegate* unmanaged[Cdecl]<nint, Vector2, uint, nint, nint, void>)funcTable[673])((nint)drawList, topCenter, col, (nint)textBegin, (nint)textEnd);
			#endif
		}
