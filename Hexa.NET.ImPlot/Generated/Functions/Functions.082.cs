...
namespace Hexa.NET.ImPlot
{
	public unsafe partial class ImPlot
	{
		...
		internal static void PlotInfLinesNative(byte* labelId, float* values, int count, ImPlotInfLinesFlags flags, int offset, int stride)
		{
			...
			((delegate* unmanaged[Cdecl]<byte*, float*, int, ImPlotInfLinesFlags, int, int, void>)vt[203])(labelId, values, count, flags, offset, stride);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, int, ImPlotInfLinesFlags, int, int, void>)vt[203])((nint)labelId, (nint)values, count, flags, offset, stride);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<byte*, double*, int, ImPlotInfLinesFlags, int, int, void>)vt[204])(labelId, values, count, flags, offset, stride);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, int, ImPlotInfLinesFlags, int, int, void>)vt[204])((nint)labelId, (nint)values, count, flags, offset, stride);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<byte*, byte*, int, ImPlotInfLinesFlags, int, int, void>)vt[205])(labelId, values, count, flags, offset, stride);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, int, ImPlotInfLinesFlags, int, int, void>)vt[205])((nint)labelId, (nint)values, count, flags, offset, stride);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<byte*, short*, int, ImPlotInfLinesFlags, int, int, void>)vt[206])(labelId, values, count, flags, offset, stride);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, int, ImPlotInfLinesFlags, int, int, void>)vt[206])((nint)labelId, (nint)values, count, flags, offset, stride);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<byte*, ushort*, int, ImPlotInfLinesFlags, int, int, void>)vt[207])(labelId, values, count, flags, offset, stride);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, int, ImPlotInfLinesFlags, int, int, void>)vt[207])((nint)labelId, (nint)values, count, flags, offset, stride);
			#endif
		}
