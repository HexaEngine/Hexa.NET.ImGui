...
namespace Hexa.NET.ImPlot3D
{
	public unsafe partial class ImPlot3D
	{
		...
		internal static void SetupAxesLimitsNative([NativeName(NativeNameType.Param, "x_min")] [NativeName(NativeNameType.Type, "double")] double xMin, [NativeName(NativeNameType.Param, "x_max")] [NativeName(NativeNameType.Type, "double")] double xMax, [NativeName(NativeNameType.Param, "y_min")] [NativeName(NativeNameType.Type, "double")] double yMin, [NativeName(NativeNameType.Param, "y_max")] [NativeName(NativeNameType.Type, "double")] double yMax, [NativeName(NativeNameType.Param, "z_min")] [NativeName(NativeNameType.Type, "double")] double zMin, [NativeName(NativeNameType.Param, "z_max")] [NativeName(NativeNameType.Type, "double")] double zMax, [NativeName(NativeNameType.Param, "cond")] [NativeName(NativeNameType.Type, "ImPlot3DCond")] ImPlot3DCond cond)
		{
			...
			((delegate* unmanaged[Cdecl]<double, double, double, double, double, double, ImPlot3DCond, void>)funcTable[14])(xMin, xMax, yMin, yMax, zMin, zMax, cond);
			#else
			((delegate* unmanaged[Cdecl]<double, double, double, double, double, double, ImPlot3DCond, void>)funcTable[14])(xMin, xMax, yMin, yMax, zMin, zMax, cond);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<float, float, byte, ImPlot3DCond, void>)funcTable[15])(elevation, azimuth, animate, cond);
			#else
			((delegate* unmanaged[Cdecl]<float, float, byte, ImPlot3DCond, void>)funcTable[15])(elevation, azimuth, animate, cond);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<ImPlot3DQuat, byte, ImPlot3DCond, void>)funcTable[16])(rotation, animate, cond);
			#else
			((delegate* unmanaged[Cdecl]<ImPlot3DQuat, byte, ImPlot3DCond, void>)funcTable[16])(rotation, animate, cond);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<float, float, void>)funcTable[17])(elevation, azimuth);
			#else
			((delegate* unmanaged[Cdecl]<float, float, void>)funcTable[17])(elevation, azimuth);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<ImPlot3DQuat, void>)funcTable[18])(rotation);
			#else
			((delegate* unmanaged[Cdecl]<ImPlot3DQuat, void>)funcTable[18])(rotation);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<float, float, float, void>)funcTable[19])(x, y, z);
			#else
			((delegate* unmanaged[Cdecl]<float, float, float, void>)funcTable[19])(x, y, z);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<ImPlot3DLocation, ImPlot3DLegendFlags, void>)funcTable[20])(location, flags);
			#else
			((delegate* unmanaged[Cdecl]<ImPlot3DLocation, ImPlot3DLegendFlags, void>)funcTable[20])(location, flags);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<byte*, float*, float*, float*, int, ImPlot3DScatterFlags, int, int, void>)funcTable[21])(labelId, xs, ys, zs, count, flags, offset, stride);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, nint, nint, int, ImPlot3DScatterFlags, int, int, void>)funcTable[21])((nint)labelId, (nint)xs, (nint)ys, (nint)zs, count, flags, offset, stride);
			#endif
		}
