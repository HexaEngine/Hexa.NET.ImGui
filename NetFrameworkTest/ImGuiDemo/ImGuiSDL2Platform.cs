namespace ExampleD3D11.ImGuiDemo
{
    ...
    public static class ImGuiSDL2Platform
    {
        ...
        private static unsafe nint GetClipboardText(nint data)
        {
            BackendData* bd = GetBackendData();
            if (bd->ClipboardTextData != null)
                sdl.Free(bd->ClipboardTextData);
            bd->ClipboardTextData = sdl.GetClipboardText();
            return (nint)bd->ClipboardTextData;
        }

        private static unsafe void SetClipboardText(nint data, nint text)
        {
        ...
        private static unsafe void SetPlatformImeData(nint context, nint vp, nint pData)
        {
            ImGuiPlatformImeData* data = (ImGuiPlatformImeData*)pData;
        ...
        private static unsafe byte OpenPlatformInShell(nint ctx, nint pPath)
        {
            byte* path = (byte*)pPath;
        ...
        private static unsafe void CreateWindow(nint pViewport)
        {
            ImGuiViewport* viewport = (ImGuiViewport*)pViewport;
            BackendData* bd = GetBackendData();
        ...
        private static unsafe void DestroyWindow(nint pViewport)
        {
            ImGuiViewport* viewport = (ImGuiViewport*)pViewport;
        ...
        private static unsafe void ShowWindow(nint pViewport)
        {
            ImGuiViewport* viewport = (ImGuiViewport*)pViewport;
            ViewportData* vd = (ViewportData*)viewport->PlatformUserData;
        ...
        private static unsafe void SetWindowPos(nint pViewport, Vector2 pos)
        {
            ImGuiViewport* viewport = (ImGuiViewport*)pViewport;
            ViewportData* vd = (ViewportData*)viewport->PlatformUserData;
        ...
        private static unsafe void SetWindowSize(nint pViewport, Vector2 size)
        {
            ImGuiViewport* viewport = (ImGuiViewport*)pViewport;
            ViewportData* vd = (ViewportData*)viewport->PlatformUserData;
        ...
        private static unsafe void SetWindowTitle(nint pViewport, nint title)
        {
            ImGuiViewport* viewport = (ImGuiViewport*)pViewport;
            ViewportData* vd = (ViewportData*)viewport->PlatformUserData;
            sdl.SetWindowTitle(vd->Window, (byte*)title);
        }

        private static unsafe void SetWindowAlpha(nint pViewport, float alpha)
        {
            ImGuiViewport* viewport = (ImGuiViewport*)pViewport;
            ViewportData* vd = (ViewportData*)viewport->PlatformUserData;
        ...
        private static unsafe void SetWindowFocus(nint pViewport)
        {
            ImGuiViewport* viewport = (ImGuiViewport*)pViewport;
            ViewportData* vd = (ViewportData*)viewport->PlatformUserData;
        ...
        private static unsafe byte GetWindowFocus(nint pViewport)
        {
            ImGuiViewport* viewport = (ImGuiViewport*)pViewport;
            ViewportData* vd = (ViewportData*)viewport->PlatformUserData;
        ...
        private static unsafe byte GetWindowMinimized(nint pViewport)
        {
            ImGuiViewport* viewport = (ImGuiViewport*)pViewport;
            ViewportData* vd = (ViewportData*)viewport->PlatformUserData;
        ...
        private static unsafe void RenderWindow(nint pViewport, nint unknown)
        {
            ImGuiViewport* viewport = (ImGuiViewport*)pViewport;
            ViewportData* vd = (ViewportData*)viewport->PlatformUserData;
        ...
        private static unsafe void SwapBuffers(nint pViewport, nint unknown)
        {
            ImGuiViewport* viewport = (ImGuiViewport*)pViewport;
            ViewportData* vd = (ViewportData*)viewport->PlatformUserData;
            if (vd->GLContext != null)
        ...
        private static unsafe int CreateVkSurface(nint pViewport, ulong vk_instance, nint vk_allocator, nint out_vk_surface)
        {
            ImGuiViewport* viewport = (ImGuiViewport*)pViewport;
            ViewportData* vd = (ViewportData*)viewport->PlatformUserData;
